...
select last_name, salary from employees where salary<47000 or salary>57000;
...
select last_name, job_id, hire_date, salary from employees where department_id = 40 and (salary > 40000 or hire_date < '2016-02-15');
